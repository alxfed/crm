...
data = pd.read_csv('/media/alxfed/toca/aa-crm/enrich/sag_emails.csv')
...
output.to_csv(path_or_buf='/media/alxfed/toca/aa-crm/enrich/sag_emails_agents1.csv', index=False)
output.to_csv(path_or_buf='/media/alxfed/toca/aa-crm/enrich/sag_emails_agents2.csv', index=False)
